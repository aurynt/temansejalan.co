		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
				<div class="fh5co-item">
					<img src="<?= base_url('assets/'); ?>images/gallery_9.jpeg" class="img-responsive" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co">
		...
		<div class="row">
			...
			<div class="col-md-6 col-md-push-1 animate-box">
				...
				<div class="flexslider">
					<ul class="slides">
					   <li style="background-image: url(<?= base_url('assets/'); ?>images/gallery_7.jpeg);">
					   ...
					   <li style="background-image: url(<?= base_url('assets/'); ?>images/gallery_6.jpeg);">
						   <div class="overlay-gradient"></div>
						   <div class="container-fluid">
							   <div class="row">
								   <div class="col-md-12 col-md-offset-0 col-md-pull-10 slider-text slider-text-bg">
					   ...
					   <li style="background-image: url(<?= base_url('assets/'); ?>images/gallery_5.jpeg);">
						   <div class="overlay-gradient"></div>
						   <div class="container-fluid">
							   <div class="row">
								   <div class="col-md-12 col-md-offset-0 col-md-pull-10 slider-text slider-text-bg">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="fh5co-blog animate-box">
					<a href="#" class="blog-bg" style="background-image: url(<?= base_url('assets/'); ?>images/gallery_1.jpeg);"></a>
					<div class="blog-text">
			...
			<div class="col-md-4">
				<div class="fh5co-blog animate-box">
					<a href="#" class="blog-bg" style="background-image: url(<?= base_url('assets/'); ?>images/gallery_2.jpeg);"></a>
					<div class="blog-text">
						<span class="posted_on">Feb. 15th 2016</span>
			...
			<div class="col-md-4">
				<div class="fh5co-blog animate-box">
					<a href="#" class="blog-bg" style="background-image: url(<?= base_url('assets/'); ?>images/gallery_3.jpeg);"></a>
					<div class="blog-text">
						<span class="posted_on">Feb. 15th 2016</span>
